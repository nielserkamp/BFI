...
void print_trace_diff(trace_t *news, trace_t *old);
void print_trace_if_diff(trace_t *news, trace_t *old);

void print_registers(registers_t *regs);
void print_registers_diff(registers_t *news, registers_t *old);
void print_registers_if_diff(registers_t *news, registers_t *old);
